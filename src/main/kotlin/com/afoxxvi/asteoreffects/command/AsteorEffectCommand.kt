...
object AsteorEffectCommand : BaseCommandHandler() {
    ...
    object Circle : BaseCommand("circle", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            sender as Player
            if (args.contains("-a")) AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA)
                .animateRing(3.0, 4, 40, 2, Math.toRadians(10.0))
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA).drawCircle(3.0, 24)
        }
    }
    ...
    object Line : BaseCommand("line", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            ...
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA).drawLine(Vector(4, 4, 4), 24)
        }
    }
    ...
    object Polygon : BaseCommand("polygon", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            ...
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA).drawPolygon(3.0, 6, 6)
        }
    }
    ...
    object Star : BaseCommand("star", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            ...
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA).drawStar(4.5, 3.0, 5, 5)
        }
    }
    ...
    object Sphere : BaseCommand("sphere", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            ...
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA).drawSphere(1.5, 240, 1.0)
        }
    }
    ...
    object Vortex : BaseCommand("vortex", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            ...
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA).drawVortex(3.0, 1.5, 20, 0.1, 6)
        }
    }
    ...
    object Triangle : BaseCommand("triangle", true) {
        override fun runCommand(sender: CommandSender, args: Array<String>) {
            ...
            else AsteorEffect.create(Particle.REDSTONE, sender.location).dustOptions(Color.AQUA)
